...
@property (atomic, copy) NIOperationBlock didStartBlock;
@property (atomic, copy) NIOperationBlock didFinishBlock;
@property (atomic, copy) NIOperationDidFailBlock didFailWithErrorBlock;
@property (atomic, copy) NIOperationBlock willFinishBlock;
